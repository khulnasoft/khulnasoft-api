...
export type KhulnasoftReactQueryClient<Api extends AnyAPIDescription> =
  ClientResource<
    ResourceConfig<
...
export function createUseReactQueryClient<Api extends AnyAPIDescription>(
  ...
  return ({
    reactQueryContext,
  }: UseKhulnasoftReactQueryClientOptions = {}): KhulnasoftReactQueryClient<Api> => {
    ...
    }, []) as KhulnasoftReactQueryClient<Api>;
    return client;
  };
}

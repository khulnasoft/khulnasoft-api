...
function main() {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    if (!packageJsonPath) {
      console.error(
        `Folder ${path_1.default.relative(
          ".",
          options.directory,
        ...
        for (const { filePath, line, column, diagnostics } of callDiagnostics) {
          output.push(
            chalk_1.default.magenta(
              `While processing codegenSchema call at ${path_1.default.relative(
                ".",
                filePath,
              )}:${line}:${column}:`,
            ),
            ...
            const importExpression = factory.createCallExpression(
              ...
              [
                factory.createStringLiteral(
                  `${(0, generateFiles_1.relativeImportPath)(
                    endpointMapGenPath,
                    (0, utils_1.convertPathToImport)(
                      (0, generateFiles_1.generatePath)(
                        file.getFilePath(),
                        generationConfig,
                      ),
                    ),

...
exports.isSymbolKhulnasoftMethod = isSymbolKhulnasoftMethod;
...
function isSymbolKhulnasoftMethod(symbol) {
  ...
  return symbolDeclarationFile.endsWith("khulnasoft.d.ts");
}
...
exports.resolve = (0, memoize_1.default)(
  (specifier, basedir) =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      return yield (0, util_1.promisify)((cb) =>
        (0, resolve_1.default)(specifier, { basedir }, cb),
      )();
    }),

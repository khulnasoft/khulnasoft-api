...
- [`khulnasoft`: Khulnasoft server and client framework](#khulnasoft-khulnasoft-server-and-client-framework)
- [Table of Contents](#table-of-contents)
- [Ecosystem](#ecosystem)
- [Getting Started](#getting-started)
  - [Installation](#installation)
  - [Create Khulnasoft instance](#create-khulnasoft-instance)
...
- Prisma: [`@khulnasoft-api/prisma`](/packages/prisma)

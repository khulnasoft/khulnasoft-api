...
import { parseEndpoint, type AnyEndpoint } from "khulnasoft";
...
> {
  ...
  return await khulnasoft.parseParamsWithContext(params, context);
}
...
export async function executeRequest<EC extends AnyEndpoint>(
  ...
  return await khulnasoft.execute(params, context);
}

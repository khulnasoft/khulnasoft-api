...
errors['622'] = 'Param not valid. Review queries documentation: https://documentation.khulnasoft.com/current/user-manual/api/queries.html'
...
errors['801'] = "Wrong format for 'khulnasoft-app-version' header. Expected format: 'X.Y.Z'";
errors['802'] = "Invalid 'khulnasoft-app-version' header";
errors['803'] = "Khulnasoft API is only available for master nodes";

...
describe('Manager', function() {
        ...
        it('Request', function(done) {
            ...
            .end(function(err,res){
                ...
                res.body.data.should.have.properties(['ossec-agentlessd', 'ossec-analysisd', 'ossec-authd', 'ossec-csyslogd', 'ossec-dbd', 'ossec-monitord',
                                                      ...
                                                      'ossec-reportd', 'ossec-syscheckd', 'khulnasoft-clusterd', 'khulnasoft-modulesd', 'khulnasoft-db']);
                done();
            });
        });
    ...
    describe('POST/manager/files', function() {
        ...
        it('Upload list (overwrite=true)', function(done) {
            ...
            .send("test-khulnasoft-w:write\ntest-khulnasoft-r:read\ntest-khulnasoft-a:attribute\ntest-khulnasoft-x:execute\ntest-khulnasoft-c:command\n")
            .auth(common.credentials.user, common.credentials.password)
            .expect("Content-type",/json/)
            .expect(200)
            .end(function(err, res) {
    ...
    describe('GET/manager/files', function() {
        ...
        it('Request decoders (global)', function(done) {
            request(common.url)
            .get("/manager/files?path=ruleset/decoders/0005-khulnasoft_decoders.xml")
            .auth(common.credentials.user, common.credentials.password)
            .expect("Content-type",/json/)
            .expect(200)
            .end(function(err,res){
        ...
        it('Request wrong path 3', function(done) {
            request(common.url)
            .get("/manager/files?path=./framework/khulnasoft/agent.py")
            .auth(common.credentials.user, common.credentials.password)
            .expect("Content-type",/json/)
            .expect(400)
            .end(function(err,res){
    ...
    describe('GET/manager/config/:component/:configuration', function () {
		...
		it('Request-Wmodules-Wmodules', function(done) {
            ...
            .end(function(err,res){
                ...
                module_list = ['cis-cat', 'database', 'open-scap', 'osquery', 'sca', 'syscollector', 'vulnerability-detector', 'khulnasoft_control', 'khulnasoft_download']

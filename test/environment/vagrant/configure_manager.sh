...
apt-get update
apt-get install khulnasoft-manager -y
...
cd ${khulnasoft_api_folder}
${khulnasoft_api_folder}/install_api.sh
...
then
    ...
    khulnasoft_database.sync_syscheck=1
EOT

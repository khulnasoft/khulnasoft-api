 ...
 * Three connected agents (excluding manager):
    * id `000` and version _Khulnasoft v3.8.0_. Must have the following additional configuration:
        ...
        * Logcollector socket:
            ...
            ```
        * Mail:
            1. Follow steps detailed [here](https://documentation.khulnasoft.com/current/user-manual/manager/manual-email-report/smtp_authentication.html).
            2.
            ```xml
            <global>
                <email_notification>yes</email_notification>
                <email_to>hello@khulnasoft.com</email_to>
                <smtp_server>localhost</smtp_server>
                <email_from>khulnasoft@test.com</email_from>
            </global>
            <email_alerts>
    ...
    * id `001` and version _Khulnasoft v3.8.0_.
    * id `002` and version _Khulnasoft v3.8.0_. Must have the following additional configuration:
        * Labels:
            ```xml
            <labels>
            ...
            ```
    * id `003` and version _Khulnasoft v3.5.0-1_.

 * DB syscheck activated: Add `khulnasoft_database.sync_syscheck=1` to the file `/var/ossec/etc/local_internal_options.conf`.
...
```shellsession
#  export KHULNASOFT_API_PATH=/your/khulnasoft/api/path
#  vagrant up
```

## Run all tests
```shellsession
#  cd /home/vagrant/khulnasoft_api

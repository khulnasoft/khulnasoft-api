...
#  Copyright (C) 2017 Khulnasoft, Inc. All rights reserved.
#  Khulnasoft.com
#
...
try{
    ...
    Write-Output "The Khulnasoft manager is contactable via the API, the response is: `n $($testresponse)"
    }catch{
...
Add-Content $config "`n<ossec_config>   <client>    <server>  <address>$($khulnasoft_manager)</address> </server>   </client> </ossec_config>"

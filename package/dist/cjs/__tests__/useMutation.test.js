    ...
    resources: {
        ...
        body: khulnasoft.resource({
            ...
            actions: {
                update: khulnasoft.endpoint({
                    endpoint: "POST /body",
                    body: khulnasoft_1.z.object({ bar: khulnasoft_1.z.string() }),
                    response: khulnasoft_1.z.any(),
                    handler() {
                        return __awaiter(this, void 0, void 0, function* () { });
                    },
        ...
        queryBody: khulnasoft.resource({
            ...
            actions: {
                update: khulnasoft.endpoint({
                    ...
                    query: khulnasoft_1.z.object({ foo: khulnasoft_1.z.string() }),
                    body: khulnasoft_1.z.object({ bar: khulnasoft_1.z.string() }),
                    response: khulnasoft_1.z.any(),
                    handler() {
                        return __awaiter(this, void 0, void 0, function* () { });
        ...
        pathQueryBody: khulnasoft.resource({
            ...
            actions: {
                update: khulnasoft.endpoint({
                    ...
                    path: khulnasoft_1.z.object({ foo: khulnasoft_1.z.string() }),
                    query: khulnasoft_1.z.object({ baz: khulnasoft_1.z.string() }),
                    body: khulnasoft_1.z.object({ bar: khulnasoft_1.z.string() }),
                    response: khulnasoft_1.z.any(),
                    handler() {
                        return __awaiter(this, void 0, void 0, function* () { });
        ...
        optionalQueryBody: khulnasoft.resource({
            ...
            actions: {
                update: khulnasoft.endpoint({
                    ...
                    query: khulnasoft_1.z.object({ foo: khulnasoft_1.z.string().optional() }),
                    body: khulnasoft_1.z.object({ bar: khulnasoft_1.z.string() }),
                    response: khulnasoft_1.z.any(),
                    handler() {
                        return __awaiter(this, void 0, void 0, function* () { });
        ...
        pathOptionalQueryBody: khulnasoft.resource({
            ...
            actions: {
                update: khulnasoft.endpoint({
                    ...
                    path: khulnasoft_1.z.object({ foo: khulnasoft_1.z.string() }),
                    query: khulnasoft_1.z.object({ baz: khulnasoft_1.z.string().optional() }),
                    body: khulnasoft_1.z.object({ bar: khulnasoft_1.z.string() }),
                    response: khulnasoft_1.z.any(),
                    handler() {
                        return __awaiter(this, void 0, void 0, function* () { });
...
it("post with path, optional query and body - onSuccess hook passed to useMutation", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    expect((_a = hookResult === null || hookResult === void 0 ? void 0 : hookResult.data) === null || _a === void 0 ? void 0 : _a.req).toMatchInlineSnapshot(`"http://localhost:3000/pathOptionalQueryBody/a"`);
    expect((_b = hookResult === null || hookResult === void 0 ? void 0 : hookResult.data) === null || _b === void 0 ? void 0 : _b.body).toMatchInlineSnapshot(`
    {
      "bar": "b",
    }
  `);
...
it("post with path, query and body - onSuccess hook passed to useMutation", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    expect((_a = hookResult === null || hookResult === void 0 ? void 0 : hookResult.data) === null || _a === void 0 ? void 0 : _a.req).toMatchInlineSnapshot(`"http://localhost:3000/pathQueryBody/a?baz=c"`);
    expect((_b = hookResult === null || hookResult === void 0 ? void 0 : hookResult.data) === null || _b === void 0 ? void 0 : _b.body).toMatchInlineSnapshot(`
    {
      "bar": "b",
    }

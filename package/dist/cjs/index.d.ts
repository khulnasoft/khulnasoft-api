import { z, type AnyAPIDescription, type AnyEndpoint, type AnyResourceConfig, type ResourceConfig, type HttpMethod, type EndpointPathInput, type GetEndpointMethod, APIRouteMap } from "khulnasoft";
...
export type KhulnasoftReactQueryClient<Api extends AnyAPIDescription> = ClientResource<ResourceConfig<Api["topLevel"]["actions"], Api["resources"], Api["topLevel"]["models"]>>;
export type UseKhulnasoftReactQueryClientOptions = {
    reactQueryContext?: ContextOptions["context"];
};
export type UseKhulnasoftReactQueryClient<Api extends AnyAPIDescription> = (options?: UseKhulnasoftReactQueryClientOptions) => KhulnasoftReactQueryClient<Api>;

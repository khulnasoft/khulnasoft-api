...
exports.PaginatorPromise = exports.ClientPromise = void 0;
...
const useInfiniteQuery_js_1 = require("./useInfiniteQuery.js");
const ClientPromise_js_1 = require("./ClientPromise.js");
Object.defineProperty(exports, "ClientPromise", { enumerable: true, get: function () { return ClientPromise_js_1.ClientPromise; } });
const PaginatorPromise_js_1 = require("./PaginatorPromise.js");
Object.defineProperty(exports, "PaginatorPromise", { enumerable: true, get: function () { return PaginatorPromise_js_1.PaginatorPromise; } });
...
function createUseReactQueryClient(baseUrl, options) {
    return ({ reactQueryContext, } = {}) => {
        ...
        const baseClient = (0, khulnasoft_1.createClient)(baseUrl, options);
        const client = (0, khulnasoft_1.createRecursiveProxy)((opts) => {
            ...
            if (method === "POST" ||
                ...
                const mutateArgs = React.useCallback((args) => {
                    ...
                    if (last && (0, useMutation_js_1.isMutateOptions)(last)) {
                        args = [...args];
            ...
            const reactQueryOptions = (isInfinite
                ? useInfiniteQuery_js_1.isUseInfiniteQueryOptions
                : useQuery_js_1.isUseQueryOptions)(args.at(-1))
                ? args.pop()
                : undefined;
            ...
            // suffices for now.
            const pathArgs = args.filter((arg) => typeof arg === "string" || typeof arg === "number");
            ...
            const doFetch = (moreQuery) => {
                ...
                return basePromise instanceof khulnasoft_1.PaginatorPromise
                    ? PaginatorPromise_js_1.PaginatorPromise.from(basePromise, { queryKey })
                    : ClientPromise_js_1.ClientPromise.from(basePromise, { queryKey });
            };
            if (isInfinite) {

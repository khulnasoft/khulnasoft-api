...
exports.Khulnasoft = exports.OpenAPIResponse = exports.NotFoundError = exports.ForbiddenError = exports.UnauthorizedError = exports.BadRequestError = exports.KhulnasoftError = exports.isKhulnasoftError = exports.apiSymbol = exports.getApiRouteMap = exports.PaginatorPromise = exports.ClientPromise = exports.createRecursiveProxy = exports.createClient = exports.z = exports.parseSelect = exports.openapiSpec = void 0;
exports.parseEndpoint = parseEndpoint;
exports.allEndpoints = allEndpoints;
exports.isAPIDescription = isAPIDescription;
...
const coerceParams_1 = __importDefault(require("./coerceParams"));
...
var createRecursiveProxy_1 = require("./createRecursiveProxy");
Object.defineProperty(exports, "createRecursiveProxy", { enumerable: true, get: function () { return createRecursiveProxy_1.createRecursiveProxy; } });
var client_2 = require("./client");
Object.defineProperty(exports, "ClientPromise", { enumerable: true, get: function () { return client_2.ClientPromise; } });
Object.defineProperty(exports, "PaginatorPromise", { enumerable: true, get: function () { return client_2.PaginatorPromise; } });
var getApiRouteMap_1 = require("./gen/getApiRouteMap");
Object.defineProperty(exports, "getApiRouteMap", { enumerable: true, get: function () { return getApiRouteMap_1.getApiRouteMap; } });
...
function isAPIDescription(value) {
    return (value === null || value === void 0 ? void 0 : value[exports.apiSymbol]) === true;
}
const isKhulnasoftError = (value) => {
    return (value instanceof KhulnasoftError ||
        (value === null || value === void 0 ? void 0 : value._isKhulnasoftError) === true);
};
exports.isKhulnasoftError = isKhulnasoftError;
/**
 ...
 */
class KhulnasoftError extends Error {
    /**
     * @param statusCode
    ...
    constructor(statusCode, response) {
        ...
        this._isKhulnasoftError = true;
    }
}
exports.KhulnasoftError = KhulnasoftError;
/** When thrown in an endpoint handler, responds with HTTP status code 400. */
class BadRequestError extends KhulnasoftError {
    /**
     * @param response  optional data included in the body of the response JSON.
     */
...
class UnauthorizedError extends KhulnasoftError {
    /**
     * @param response  optional data included in the body of the response JSON.
     */
    constructor(response) {
...
class ForbiddenError extends KhulnasoftError {
    /**
     * @param response  optional data included in the body of the response JSON.
     */
    constructor(response) {
...
class NotFoundError extends KhulnasoftError {
    /**
     * @param response  optional data included in the body of the response JSON.
     */
    constructor(response) {
...
class Khulnasoft {
    ...
    loadEndpointTypeSchemas(endpoint) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!endpoint.query &&
                ...
                !endpoint.response) {
                if (!this.typeSchemas) {
                    throw new Error("Failed to provide `typeSchemas` to khulnasoft instance while using codegen schemas");
                }
                try {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                if (context.endpoint.query) {
                    (_a = (_d = context.endpoint)[coercedQuery]) !== null && _a !== void 0 ? _a : (_d[coercedQuery] = (0, coerceParams_1.default)(context.endpoint.query));
                ...
                if (context.endpoint.path) {
                    (_b = (_e = context.endpoint)[coercedPath]) !== null && _b !== void 0 ? _b : (_e[coercedPath] = (0, coerceParams_1.default)(context.endpoint.path));
                    context.parsedParams.path = yield context.endpoint[coercedPath]
                        .parseAsync(params.path, parseParams)
                        .catch(prependZodPath("<path>"));
                }
                context.parsedParams.body = yield ((_c = context.endpoint.body) === null || _c === void 0 ? void 0 : _c.parseAsync(params.body, parseParams).catch(prependZodPath("<body>")));
            }
            catch (error) {
                if (error instanceof z.ZodError) {
                    let validationError = (0, v3_1.fromZodError)(error).message;
    ...
    endpoint(params) {
        ...
        return Object.assign({ khulnasoft: this, config: config, response: (response || z.void()), path: path, query: query, body: body }, rest);
    }
    /**
     * Creates a resource.
     *
    ...
    api({ basePath, openapi, topLevel, resources, }) {
        ...
        if (openapiEndpoint !== false) {
            topLevelActions.getOpenapi = this.endpoint({
                ...
                handler() {
                    return __awaiter(this, void 0, void 0, function* () {
                        return (yield (0, openapiSpec_1.openapiSpec)(apiDescription));
                    });
                },
            });
        }

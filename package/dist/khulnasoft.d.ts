 ...
 */
export type Handler<Ctx, Path extends ZodObjectSchema | undefined, Query extends ZodObjectSchema | undefined, Body extends ZodObjectSchema | undefined, TResponseSchema> = (
...
ctx: Ctx) => TResponseSchema | Promise<TResponseSchema>;
/**
...
export interface BaseEndpoint<Config extends EndpointConfig | undefined, MethodAndUrl extends HttpEndpoint, Path extends ZodObjectSchema | undefined, Query extends ZodObjectSchema | undefined, Body extends ZodObjectSchema | undefined, TResponseSchema extends z.ZodTypeAny | undefined> {
 ...
 */
export interface Endpoint<Config extends EndpointConfig | undefined, MethodAndUrl extends HttpEndpoint, Path extends ZodObjectSchema | undefined, Query extends ZodObjectSchema | undefined, Body extends ZodObjectSchema | undefined, TResponseSchema extends z.ZodTypeAny | undefined> {
    handler?: Handler<KhulnasoftContext<BaseEndpoint<Config, MethodAndUrl, Path, Query, Body, TResponseSchema>>, Path, Query, Body, HandlerResponseInputType<TResponseSchema>>;
}
...
export declare const isKhulnasoftError: (value: unknown) => value is KhulnasoftError;
/**
 ...
 */
export declare class KhulnasoftError extends Error {
    statusCode: number;
    response?: Record<string, any> | undefined;
    _isKhulnasoftError: boolean;
    /**
     * @param statusCode
...
export declare class BadRequestError extends KhulnasoftError {
    /**
     * @param response  optional data included in the body of the response JSON.
     */
...
export declare class UnauthorizedError extends KhulnasoftError {
    /**
     * @param response  optional data included in the body of the response JSON.
     */
    constructor(response?: Record<string, any>);
...
export declare class ForbiddenError extends KhulnasoftError {
    /**
     * @param response  optional data included in the body of the response JSON.
     */
    constructor(response?: Record<string, any>);
...
export declare class NotFoundError extends KhulnasoftError {
    /**
     * @param response  optional data included in the body of the response JSON.
     */
    constructor(response?: Record<string, any>);
...
export type KhulnasoftPlugin<Statics extends AnyStatics | undefined = undefined> = {
    /**
     ...
     */
    middleware?: <EC extends AnyEndpoint>(params: Params, context: KhulnasoftContext<EC>) => void | Promise<void>;
};
/**
 * An interface allowing `khulnasoft` to initialize plugins
 * passed to the {@link Khulnasoft} constructor's `plugins` parameter.
 */
export type MakeKhulnasoftPlugin<Statics extends AnyStatics | undefined = undefined, Plugins extends AnyPlugins = {}> = (khulnasoft: Khulnasoft<Plugins>) => KhulnasoftPlugin<Statics>;
...
export type KhulnasoftHeaders = Record<string, string | string[] | undefined>;
/**
 ...
 */
export interface KhulnasoftContext<EC extends AnyBaseEndpoint> extends BaseKhulnasoftContext<EC>, KhulnasoftCustomContext {
}
...
interface CreateEndpointOptions<MethodAndUrl extends HttpEndpoint, Config extends EndpointConfig | undefined, Path extends ZodObjectSchema | undefined, Query extends ZodObjectSchema | undefined, Body extends ZodObjectSchema | undefined, TResponseSchema extends z.ZodTypeAny = z.ZodVoid> {
    /**
 ...
 */
export declare class Khulnasoft<Plugins extends AnyPlugins> {
    plugins: ExtractStatics<Plugins>;
    private khulnasoftPlugins;
    private typeSchemas?;
    /**
     *
     ...
     */
    initContext<EC extends AnyEndpoint>(c: KhulnasoftContext<EC>): KhulnasoftContext<EC>;
    /**
     ...
     */
    parseParams<EC extends AnyEndpoint>(params: Params, context: KhulnasoftContext<EC>): Promise<RequestData<EC["path"], EC["query"], EC["body"]>>;
    /**
     ...
     * @returns a Promise that resolves to [request, context]
     */
    parseParamsWithContext<EC extends AnyEndpoint>(params: Params, context: KhulnasoftContext<EC>): Promise<[
     ...
     */
    execute<EC extends AnyEndpoint>(params: Params, context: KhulnasoftContext<EC>): Promise<ExtractExecuteResponse<EC>>;
    /**
     * Creates an endpoint.
     *
     ...
     * ```
     */
    types<T extends Types>(): TypeEndpointBuilder<TypeArgToZodObject<T, "path">, TypeArgToZodObject<T, "query">, TypeArgToZodObject<T, "body">, any>;
}
...
interface TypeEndpointParams<MethodAndUrl extends HttpEndpoint, Config extends EndpointConfig | undefined, Path extends ZodObjectSchema | undefined, Query extends ZodObjectSchema | undefined, Body extends ZodObjectSchema | undefined, TResponse extends z.ZodTypeAny = z.ZodVoid> {
    endpoint: MethodAndUrl;
    config?: Config;
    handler?: Handler<KhulnasoftContext<BaseEndpoint<Config, MethodAndUrl, Path, Query, Body, Response>>, Path, Query, Body, z.input<Response>>;
}
interface TypeEndpointBuilder<Path extends ZodObjectSchema | undefined, Query extends ZodObjectSchema | undefined, Body extends ZodObjectSchema | undefined, TResponse extends z.ZodTypeAny = z.ZodVoid> {
...
//# sourceMappingURL=khulnasoft.d.ts.map
...
exports.ConvertTypeContext = exports.SchemaGenContext = exports.ErrorAbort = void 0;
...
function isKhulnasoftSymbol(symbol) {
    return isSymbolInFile(symbol, /khulnasoft\/dist\/.*\.d\.ts$/);
}
function isZodSymbol(symbol) {
    return (isSymbolInFile(symbol, /zod\/lib\/.*\.d\.ts$/) || isKhulnasoftSymbol(symbol));
}
function isTsToZodSymbol(symbol) {
    return isKhulnasoftSymbol(symbol);
}
function isKhulnasoftPrismaSymbol(symbol) {

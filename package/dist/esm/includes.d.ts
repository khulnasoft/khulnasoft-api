import * as z from "./z";
import { type KhulnasoftContext } from "./khulnasoft";
export declare const includesSymbol: unique symbol;
/**
...
export declare function getIncludes(ctx: KhulnasoftContext<any>): string[] | null | undefined;
export {};

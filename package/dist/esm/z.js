 ...
 */
class KhulnasoftSelectable extends z.ZodOptional {
    _parse(input) {
        var _a, _b;
...
z.ZodType.prototype.selection = function selection() {
    ...
    const mask = mapValues(shape, (value) => value instanceof KhulnasoftSelectable ? undefined : true);
...
z.ZodType.prototype.khulnasoftTransform = function khulnasoftTransform(transform) {
...
export function khulnasoftPreprocess(preprocess, schema) {
    return new z.ZodEffects({
...
export class KhulnasoftParams extends z.ZodObject {
}
export function query(shape, params) {
    return new KhulnasoftParams(z.object(shape, params)._def);
}
...
export function pageResponse(item) {
    ...
    return response(Object.assign(Object.assign({}, commonPageResponseFields), { items: z.array(item) })).withMetadata(Object.assign(Object.assign({}, baseMetadata), { khulnasoft: Object.assign(Object.assign({}, baseMetadata === null || baseMetadata === void 0 ? void 0 : baseMetadata.khulnasoft), { pageResponse: true }) }));
}
...
export const IncludableSymbol = Symbol("Includable");
export class Includable extends Schema {
}
export class Includes extends Schema {
}
export const SelectableSymbol = Symbol("Selectable");
export class Selectable extends Schema {
}
export class Selects extends Schema {
}
export class Selection extends Schema {
}
const PageResponseSymbol = Symbol("PageResponse");
export class PageResponse extends Schema {
}
const ZodSchemaSymbol = Symbol("ZodSchema");
export class ZodSchema extends Schema {
}

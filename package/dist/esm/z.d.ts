 ...
 * that you must import khulnasoft _before_ zod
...
declare module "zod" {
    interface ZodType<Output, Def extends ZodTypeDef, Input = Output> {
        safeParseAsync(data: unknown, params?: Partial<KhulnasoftParseParams>): Promise<SafeParseReturnType<Input, Output>>;
        parseAsync(data: unknown, params?: Partial<KhulnasoftParseParams>): Promise<Output>;
        transform<T extends z.ZodTypeAny, NewOut>(this: T, transform: (arg: Output, ctx: KhulnasoftRefinementCtx) => NewOut | Promise<NewOut>): z.ZodEffects<T, NewOut>;
        /**
         ...
         * Prisma plugin.
         */
        khulnasoftTransform<T extends z.ZodTypeAny, NewOut>(this: T, transform: KhulnasoftTransform<Output, NewOut>): z.ZodEffects<T, NewOut>;
    }
}
export type KhulnasoftTransform<Input, Output> = (input: Input, ctx: KhulnasoftContext<any>, zodInput: z.ParseInput) => Output | Promise<Output>;
export interface KhulnasoftParseContext extends z.ParseContext {
    khulnasoftContext?: KhulnasoftContext<any>;
}
export interface KhulnasoftRefinementCtx extends z.RefinementCtx {
    khulnasoftContext?: KhulnasoftContext<any>;
}
export type KhulnasoftParseParams = z.ParseParams & {
    khulnasoftContext: KhulnasoftContext<any>;
};
export type KhulnasoftParseInput = z.ParseInput & {
    parent: KhulnasoftParseContext;
};
export type KhulnasoftPreprocess = (input: unknown, ctx: KhulnasoftContext<any>, zodInput: z.ParseInput) => unknown;
export declare function khulnasoftPreprocess<I extends z.ZodTypeAny>(preprocess: KhulnasoftPreprocess, schema: I): z.ZodEffects<I, I["_output"], unknown>;
export declare function path<T extends z.ZodRawShape>(shape: T, params?: z.RawCreateParams): z.ZodObject<T, "strip">;
export declare class KhulnasoftParams<T extends z.ZodRawShape, UnknownKeys extends z.UnknownKeysParam = z.UnknownKeysParam, Catchall extends z.ZodTypeAny = z.ZodTypeAny, Output = z.objectOutputType<T, Catchall, UnknownKeys>, Input = z.objectInputType<T, Catchall, UnknownKeys>> extends z.ZodObject<T, UnknownKeys, Catchall, Output, Input> {
}
export declare function query<T extends z.ZodRawShape>(shape: T, params?: z.RawCreateParams): KhulnasoftParams<T, "strip">;
export declare function body<T extends z.ZodRawShape>(shape: T, params?: z.RawCreateParams): KhulnasoftParams<T, "strip">;
...
export declare class Schema<O, I = O> extends BaseSchema {
    ...
    output: O;
    default: O | (() => O);
    validate(value: Out<I>, ctx: KhulnasoftContext<any>): void;
    transform(value: Out<I>, ctx: KhulnasoftContext<any>, zodInput: z.ParseInput): Out<O> | PromiseLike<Out<O>>;
}
...
export type toZod<T> = 0 extends 1 & T ? any : T extends z.ZodTypeAny ? T : T extends BaseSchema ? schemaTypeToZod<T> : T extends Date ? z.ZodDate : T extends Array<infer E> ? z.ZodArray<toZod<E>> : T extends Set<infer E> ? z.ZodSet<toZod<E>> : T extends Map<infer K, infer V> ? z.ZodMap<toZod<K>, toZod<V>> : T extends PromiseLike<infer E> ? z.ZodPromise<toZod<E>> : T extends object ? z.ZodObject<{
    [k in keyof T]-?: toZod<NonNullable<T[k]>>;
}> : T extends number ? z.ZodNumber : T extends string ? z.ZodString : T extends boolean ? z.ZodBoolean : T extends bigint ? z.ZodBigInt : z.ZodType<Out<T>, any, In<T>>;

import { AnyEndpoint, AnyResourceConfig, EndpointHasRequiredQuery, EndpointQueryInput, EndpointResponseOutput, z } from "khulnasoft";
...
export declare const isUseInfiniteQueryOptions: (obj: unknown) => obj is BaseUseInfiniteQueryOptions;

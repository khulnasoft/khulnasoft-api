import { z, AnyAPIDescription, AnyEndpoint, AnyResourceConfig, ResourceConfig, HttpMethod, APIRouteMap, EndpointPathInput, EndpointBodyInput, EndpointQueryInput, HttpPath, HttpEndpoint, EndpointHasRequiredQuery } from "./khulnasoft";
 ...
 * `khulnasoft` client utilizes proxies in order to provide a mapping
 ...
 * ```
 */
export type KhulnasoftClient<Api extends AnyAPIDescription> = ClientResource<ResourceConfig<Api["topLevel"]["actions"], Api["resources"], Api["topLevel"]["models"]>>;
 ...
 */
export declare function createClient<Api extends AnyAPIDescription>(baseUrl: string, options?: CreateClientOptions): KhulnasoftClient<Api>;
...
export declare class PageImpl<D extends z.PageData<any>> {
    ...
    private params;
    data: D;
    constructor(client: KhulnasoftClient<any>, clientPath: string[], pathname: string, params: z.infer<typeof z.PaginationParams>, data: D);
    /** The items in a page. */

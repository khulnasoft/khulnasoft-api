...
const genApiRouteMap_1 = require("../gen/genApiRouteMap");
...
function go() {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      Usage: gen-khulnasoft-api-route-map <api files>
    ...
    `);
        ...
        for (const file of files) {
            yield (0, genApiRouteMap_1.genApiRouteMap)(file);
        }
    });
}
go();
//# sourceMappingURL=gen-khulnasoft-api-route-map.js.map
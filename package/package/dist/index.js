...
commander_1.program.option("-o, --outdir <path>", "the directory in which to generate schemas", ".khulnasoft-codegen");
...
function evaluate(project_1, baseCtx_1, generationConfig_1, printer_1, outdir_1) {
    return __awaiter(this, arguments, void 0, function* (project, baseCtx, generationConfig, printer, outdir, { isDirty = () => false } = {}) {
        var _a;

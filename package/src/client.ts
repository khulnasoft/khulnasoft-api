 ...
 * ```
 */
export type KhulnasoftClient<Api extends AnyAPIDescription> = ClientResource<
  ResourceConfig<
...
export class PageImpl<D extends z.PageData<any>> {
  constructor(
    private client: KhulnasoftClient<any>,

...
import (
	...
	"github.com/stainless-sdks/khulnasoft-api-go/internal/apiform"
	"github.com/stainless-sdks/khulnasoft-api-go/internal/apijson"
	"github.com/stainless-sdks/khulnasoft-api-go/internal/apiquery"
	shimjson "github.com/stainless-sdks/khulnasoft-api-go/internal/encoding/json"
	"github.com/stainless-sdks/khulnasoft-api-go/internal/requestconfig"
	"github.com/stainless-sdks/khulnasoft-api-go/option"
	"github.com/stainless-sdks/khulnasoft-api-go/packages/param"
	"github.com/stainless-sdks/khulnasoft-api-go/packages/respjson"
)

// PetService contains methods and other services that help with interacting with
// the khulnasoft-api API.
//
...
func (r *PetService) UpdateWithForm(ctx context.Context, petID int64, body PetUpdateWithFormParams, opts ...option.RequestOption) (err error) {
	opts = slices.Concat(r.Options, opts)
	opts = append([]option.RequestOption{option.WithHeader("Accept", "*/*")}, opts...)
	path := fmt.Sprintf("pet/%v", petID)
...
// uploads an image
func (r *PetService) UploadImage(ctx context.Context, petID int64, body io.Reader, body PetUploadImageParams, opts ...option.RequestOption) (res *PetUploadImageResponse, err error) {
	opts = slices.Concat(r.Options, opts)
...
type PetUpdateWithFormParams struct {
...
// URLQuery serializes [PetUpdateWithFormParams]'s query parameters as
// `url.Values`.
func (r PetUpdateWithFormParams) URLQuery() (v url.Values, err error) {
	return apiquery.MarshalWithSettings(r, apiquery.QuerySettings{
		ArrayFormat:  apiquery.ArrayQueryFormatComma,
		NestedFormat: apiquery.NestedQueryFormatBrackets,
	})

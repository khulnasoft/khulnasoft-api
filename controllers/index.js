...
khulnasoft_control = api_path + "/models/khulnasoft-api.py";
...
router.get('/',function(req, res) {
    ...
    data = { 'msg': "Welcome to Khulnasoft HIDS API", 'api_version': "v" + info_package.version, 'hostname': os.hostname(), 'timestamp': new Date().toString()}

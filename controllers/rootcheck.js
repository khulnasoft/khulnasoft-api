 ...
 *
 *
 * @apiDescription Runs syscheck and rootcheck on all agents (Khulnasoft launches both processes simultaneously).
 *
 * @apiExample {curl} Example usage*:
 ...
 * @apiParam {Number} agent_id Agent ID.
 *
 * @apiDescription Runs syscheck and rootcheck on a specified agent (Khulnasoft launches both processes simultaneously)
 *
 * @apiExample {curl} Example usage:

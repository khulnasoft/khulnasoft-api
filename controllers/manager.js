...
/**
 * @api {put} /manager/restart Restart Khulnasoft manager
 * @apiName PutRestartManager
 * @apiGroup Restart
 *
 * @apiDescription Restarts Khulnasoft Manager.
 *
 * @apiExample {curl} Example usage*:
...
/**
 * @api {get} /manager/configuration/validation Check Khulnasoft configuration
 * @apiName GetManagerConfiguration
 * @apiGroup Files
 *

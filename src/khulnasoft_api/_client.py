...
class KhulnasoftAPI(SyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        if base_url is None:
            base_url = os.environ.get("KHULNASOFT_API_BASE_URL")
        if base_url is None:
    ...
    @cached_property
    def with_raw_response(self) -> KhulnasoftAPIWithRawResponse:
        return KhulnasoftAPIWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> KhulnasoftAPIWithStreamedResponse:
        return KhulnasoftAPIWithStreamedResponse(self)
...
class AsyncKhulnasoftAPI(AsyncAPIClient):
    ...
    @cached_property
    def with_raw_response(self) -> AsyncKhulnasoftAPIWithRawResponse:
        return AsyncKhulnasoftAPIWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncKhulnasoftAPIWithStreamedResponse:
        return AsyncKhulnasoftAPIWithStreamedResponse(self)
...
AsyncClient = AsyncKhulnasoftAPI

...
import { Khulnasoft, UnauthorizedError, z } from "khulnasoft";
import { describe, expect, test } from "vitest";
import { khulnasoftApi } from "./honoPlugin";
...
describe("hono passthrough", () => {
        ...
        actions: {
          ...
          create: khulnasoft.endpoint({
            ...
            handler: async (body, context) => {
              ...
              return { bodyKhulnasoft: body, bodyRaw: await c.req.raw.text() };
            },
          }),
        },
      }),
  ...
  const app = new Hono();
  app.use("*", khulnasoftApi(baseApi, { handleErrors: false }));
  app.all("/public/*", (c) => {

      ...
      ? /** Add types for path parameter method */
        {
          <AN extends ActionName>(
            ...
            pathParam: /** The pathParam _should_ be EPConfig["path"][H["name"]], but the types from khulnasoft.api seem incomplete and so that was always unknown */
            | (string | number)
...
export interface ClientConfig<BP extends string = string> {
  /**
   * This needs to match what is passed to khulnasoft.api() when creating an API

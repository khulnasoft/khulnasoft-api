...
const listDogTreat = khulnasoft.endpoint({
...
const retrieveDogTreat = khulnasoft.endpoint({
...
const updateDogTreat = khulnasoft.endpoint({
...
export const dogTreats = khulnasoft.resource({
  summary: "Dog Treats",
  actions: {
    list: listDogTreat,

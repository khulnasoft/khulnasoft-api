...
exports.PrismaModelLoader = exports.PrismaModelLoaderSymbol = exports.PrismaModel = exports.PrismaModelSymbol = exports.makePrismaPlugin = void 0;
...
function extractPrismaModel(schema) {
    var _a;
    const metadata = khulnasoft_1.z.extractDeepMetadata(schema, {
        khulnasoft: { prismaModel: () => { } },
    });
    if (metadata) {
        return (_a = metadata === null || metadata === void 0 ? void 0 : metadata.khulnasoft) === null || _a === void 0 ? void 0 : _a.prismaModel();
    }
    return undefined;
}
khulnasoft_1.z.ZodType.prototype.prismaModelLoader = function prismaModelLoader(prismaModel) {
    const result = this.khulnasoftTransform((id, ctx, zodInput) => __awaiter(this, void 0, void 0, function* () {
...
khulnasoft_1.z.ZodType.prototype.prismaModel = function prismaModel(prismaModel) {
...
function endpointWrapQuery(endpoint, context, prismaQuery) {
    ...
    if (khulnasoft_1.z.isPageResponse(response)) {
...
const makePrismaPlugin = () => (khulnasoft) => {
    return {
        statics: {
            pagination: {
                wrapQuery,
...
/**
 * Converts an include parameter from khulnasoft format
...
class PrismaModel extends khulnasoft_1.z.Schema {
}
exports.PrismaModel = PrismaModel;
exports.PrismaModelLoaderSymbol = Symbol("PrismaModelLoader");
class PrismaModelLoader extends khulnasoft_1.z.Schema {
    transform(id, ctx) {
        return __awaiter(this, void 0, void 0, function* () {
            const query = { where: { id } };
            const prisma = ctx.prisma;

import { MakeKhulnasoftPlugin, KhulnasoftContext, z } from "khulnasoft";
declare module "zod" {
...
export declare const makePrismaPlugin: () => MakeKhulnasoftPlugin<PrismaStatics>;
...
export declare abstract class PrismaModelLoader<O, I> extends z.Schema<O, I> {
    ...
    transform(id: z.Out<I>, ctx: KhulnasoftContext<any>): Promise<z.Out<O>>;
}
export {};

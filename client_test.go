...
import (
	...
	"github.com/stainless-sdks/khulnasoft-api-go/internal"
...
func TestUserAgentHeader(t *testing.T) {
	...
	client.Pet.Update(context.Background(), khulnasoftapi.PetUpdateParams{
		Pet: khulnasoftapi.PetParam{
			Name:      "doggie",
			PhotoURLs: []string{"string"},
		},
	})
	if userAgent != fmt.Sprintf("KhulnasoftAPI/Go %s", internal.PackageVersion) {
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Pet.Update(context.Background(), khulnasoftapi.PetUpdateParams{
		Pet: khulnasoftapi.PetParam{
			Name:      "doggie",
			PhotoURLs: []string{"string"},
		},
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Pet.Update(cancelCtx, khulnasoftapi.PetUpdateParams{
		Pet: khulnasoftapi.PetParam{
			Name:      "doggie",
			PhotoURLs: []string{"string"},
		},
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Pet.Update(deadlineCtx, khulnasoftapi.PetUpdateParams{
			Pet: khulnasoftapi.PetParam{
				Name:      "doggie",
				PhotoURLs: []string{"string"},
			},

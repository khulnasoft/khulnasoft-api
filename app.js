...
/**
 * Check Khulnasoft app version
 * Using: Header: "khulnasoft-app-version: X.Y.Z"
 */
app.use(function(req, res, next) {
    var go_next = true;
    var app_version_header = req.get('khulnasoft-app-version');

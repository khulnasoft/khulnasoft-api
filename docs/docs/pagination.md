...
convention](/khulnasoft/intro#pristine).
...
`khulnasoft` exports the following types from
...
The `@khulnasoft-api/prisma` plugin makes it easy to implement [paginated
list endpoints from Prisma schemas](/khulnasoft/prisma/pagination).

...
```
npm i --save 'khulnasoft/khulnasoft-api#react-query-0.0.1'
```

## Create client hook

Using React Query with Khulnasoft begins with creating a `useClient`
...
`useClient()` returns a Khulnasoft React Query client instance.

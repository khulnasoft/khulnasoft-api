...
```bash
npm i --save  'khulnasoft/khulnasoft-api#khulnasoft-0.0.3' \
              'khulnasoft/khulnasoft-api#next-0.0.3' \
              'khulnasoft/khulnasoft-api#react-query-0.0.3' \
              'khulnasoft/khulnasoft-api#cli-0.0.3'

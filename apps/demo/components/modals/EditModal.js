  ...
  (0, react_1.useEffect)(
    ...
    [
      ...
      currentUser === null || currentUser === void 0
        ? void 0
        : currentUser.username,
      currentUser === null || currentUser === void 0 ? void 0 : currentUser.bio,
      currentUser === null || currentUser === void 0
        ? void 0
        : currentUser.profileImage,
      currentUser === null || currentUser === void 0
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                axios_1.default.patch("/api/edit", {
                  name: name,
                  username: username,
                  bio: bio,
            ...
            case 1:
              _a.sent();
              mutateFetchedUser();
              react_hot_toast_1.toast.success("Updated");
              editModal.onClose();
              return [3 /*break*/, 4];
            case 2:
              error_1 = _a.sent();
